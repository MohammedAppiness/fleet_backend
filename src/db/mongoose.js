...
async function helper(booking){
                              ...
                              let bb=booking.map((bk)=>{
                                if(bk.customer_id==undefined) {
                             return null
                                }
                              const cx=customerDetails.find((c)=>{
                                console.log(c._id.toString(),bk.customer_id.toString())
                                return   c._id.toString()==bk.customer_id.toString()
                              }
                         ...
                         let bbfiltered=bb.filter((d)=>d!=null)
                        resolve(bbfiltered)
                      })
                 }
