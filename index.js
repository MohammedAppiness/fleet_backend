...
app.patch('/updateBooking/:id',async(req,res)=>{
    ...
    try {
        ...
        const bookingupdate = await bookings.findByIdAndUpdate(req.params.id,req.body.employee,{new:true})
// console.log(bookingupdate)

// console.log(bookingupdate.customer_id)
        const customerdata = await customer.findByIdAndUpdate(bookingupdate.customer_id,req.body.employee,{new:true})
...
app.delete('/delete/:id',async(req,res)=>{
    ...
    const d=-await bookings.findByIdAndDelete(req.params.id);
    console.log(d)
    res.send('deleted')
})
